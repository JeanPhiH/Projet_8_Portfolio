			...
			<div className="flex gap-12 flex-col justify-center items-center ">
				...
				{jsonProjects.map((project) => (
					...
					>
						...
						/>
						<h3 className="bg-dark/75 text-light w-full lg:w-[150px] p-3 rounded-xl lg:absolute left-5 bottom-5 text-center lg:group-hover/project:left-20 lg:group-hover/project:bottom-[150px] duration-500">
							{project.title}
						</h3>

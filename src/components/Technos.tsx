	...
	return (
		<section className="p-10 md:rounded-xl bg-light/15 flex flex-col items-center md:w-2/3 md:mx-auto shadow-lg shadow-light/50">
			...
			{/* <div className="h-28 lg:h-36">
				<Image
					className="relative top-28 right-28 lg:w-14 lg:top-36 lg:right-48"
				...
				/>
				<Image
					className="relative top-10 right-12 lg:w-14 lg:top-5 lg:right-20"
				...
				/>
				<Image
					className="relative top-5 left-10 lg:w-14 lg:-top-6 lg:left-20"
				...
				/>
				<Image
					className="relative top-8 left-28 lg:w-14 lg:-top-2 lg:left-48"
			...
			<div>
				<svg className="z-1 rounded-full w-[240px] h-[240px] -rotate-[30deg]">
					<defs>
						<path
							id="circle"
							d="

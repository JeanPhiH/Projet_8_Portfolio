	...
	return (
		<section className="md:flex flex-col lg:flex-row-reverse md:justify-between items-center">
			...
			<article className="mt-10 md:w-3/4 mx-auto lg:w-1/2 lg:px-20 lg:self-center">
				...
				<p>
					J’ai étudié chez OpenClassrooms et j’y ai aimé l’importance accordée à
					la <span className="text-highlight dark:text-highdark">pratique</span> et à l’
					<span className="text-highlight dark:text-highdark">autonomie</span>.
				</p>
				<p>
					J’aime les distributions <span className="text-highlight dark:text-highdark">Linux</span>
					, la logique <span className="text-highlight dark:text-highdark">React</span> et les{" "}
					<span className="text-highlight dark:text-highdark">animations CSS</span>.
				</p>
			...
			<div className="w-[300px] h-[500px] mx-auto relative mt-10 lg:w-[400px] lg:h-[375px] lg:animate-wiggle lg:hover:animate-none">
				...
				<p className="hidden text-center lg:block italic lg:absolute top-28 right-0 lg:w-1/3">
					À dix ans, j’écrivais mon premier code en basic sur un Amstrad cpc 464
					à cassette.
				</p>
				...
				<p className="italic text-center mt-96 lg:mt-0 lg:absolute left-4 bottom-5 lg:w-1/2">
					J’écris, anime et enregistre des sessions JDR, la dernière en date se
					déroule dans l’univers des backrooms.
				</p>
			</div>
		</section>
	);

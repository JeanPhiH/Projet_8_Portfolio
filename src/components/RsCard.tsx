...
export default function RsCard({
	...
	return (
		<div className="flex flex-col gap-2 items-center justify-between p-3 border-2 border-light w-52 h-96 rounded-t-full rounded-b-full hover:shadow-lg hover:shadow-light">
